...
from Model.state import names_dic
...
def unique_list(list_of_words):
    words = [item for sublist in list_of_words for item in sublist]
    content_words_unique = set(words)
    return list(content_words_unique)
